INSERT OR IGNORE INTO products (id, name, slug, is_active, created_at, updated_at, disabled_at)
VALUES ('prod-bike', 'Bike', 'bike', 1, '2026-09-01T00:00:00.000Z', '2026-09-01T00:00:00.000Z', NULL);

INSERT OR IGNORE INTO sellers (id, product_id, url, normalized_url, is_active, created_at, updated_at, disabled_at)
VALUES
...
INSERT OR IGNORE INTO price_snapshots (id, seller_id, scraped_at, price_cents, price_text, status, error_code, error_message, raw_response, created_at)
VALUES
...
INSERT OR IGNORE INTO subscriptions (id, product_id, email, normalized_email, is_active, created_at, updated_at, unsubscribed_at)
...
INSERT OR IGNORE INTO notification_logs (id, product_id, subscription_id, seller_id, sent_at, status, price_cents, previous_price_cents, reason, error_message, dedupe_key, created_at)
